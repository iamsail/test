...
<!-- 左边信息栏开始 -->
   ...
   <section class='data needData'>
     ...
     <div id='detail-header'><a href="#" id='detail-back'><</a>个人页</div>
       <div id='user-data'>
         <div id='user-head'><img id='user-headimg' src="" alt="用户头像"></div>
         ...
         <!-- <div id='user-cancel'>注销</div> -->
          <div id='user-back'>返回</div>
          <div id='user-cancel'><a href="Home/Index/logout">注销</a></div>
...
<!--          <div class='publish-data'>
        <div class='publish-info1'>
           <span class='publish-headline'>1:11111</span>
           <p class='publish-content'>222222222</p>
           <img class='publish-img1' src='img/1.jpg' alt=''>
           <img class='publish-img2' src='' alt=''> 
           <span class='publish-start'>3333333</span>
           <span class='publish-stop'>44444444</span>
        </div>
